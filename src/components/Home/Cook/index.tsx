      ...
      <div className="container mx-auto lg:max-w-screen-xl md:max-w-screen-md">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 my-16">
          ...
          <div className="flex flex-col justify-center space-y-6">
            {/* Subtitle */}
            <p className="text-[#238967] text-lg font-extrabold  tracking-widest uppercase">
              About Us
            </p>
            ...
            <p className="text-black/50 dark:text-white/50 text-lg font-normal">
              Welcome to Baks Hotel, where comfort meets elegance.
            ...
            <a
              ...
              className="text-xl font-medium rounded-full text-white py-4 px-6 bg-[#238967] hover:bg-transparent hover:text-[#238967] border border-black w-fit transition duration-300"
            >
              Call Now
            </a>
          </div>
